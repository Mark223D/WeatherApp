...
public struct WormTabStripStylePropertyies {
    ...
    var kHeightOfTopScrollView:CGFloat = 40
    ...
    var kPaddingOfIndicator:CGFloat = 40
    
    //initial value for the tabs margin
    var kWidthOfButtonMargin:CGFloat = 9
    ...
    var tabItemDefaultColor:UIColor = .lightGray
    ...
    var topScrollViewBackgroundColor:UIColor = .darkGray
